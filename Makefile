...
objdir    := objs
stdcpp    := c++11
cuda_home := /home/zas/anaconda3/envs/trt/lib/python3.9/site-packages/trtpy/trt8cuda115cudnn8
syslib    := /home/zas/anaconda3/envs/trt/lib/python3.9/site-packages/trtpy/lib
cpp_pkg   := /home/zas/anaconda3/envs/trt/lib/python3.9/site-packages/trtpy/cpp-packages
cuda_arch := 
...
link_librarys  := $(link_sys) $(link_opencv)  $(link_onnx)
pwd            := ${shell pwd}


onnx_root      := $(pwd)/onnxruntime-linux-x64-1.13.1
...
cpp_compile_flags := -std=$(stdcpp) -w -g -O0 -m64 -fPIC -fopenmp -pthread -DWITH_OPENVINO
